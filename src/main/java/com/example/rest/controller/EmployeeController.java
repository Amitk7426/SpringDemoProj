...
public class EmployeeController {
	...
	public List<Employee> getEmployees(@RequestHeader(name = "X-COM-PERSIST", defaultValue = "true") String headerPersist,
	...
	public ResponseEntity<Object> addEmployee(
		...
		Integer id = employeeManager.getEmployeeList().size() + bd1.intValue();
		employee.setId(id);
